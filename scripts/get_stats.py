...
if __name__ == "__main__":
    ...
    desc ="Calcul statistics of the labels from a label image and raster." +\
            ...
            " * n_stat_features bands. This method use the GDAL et NUMPY " +\
            "library."
    ...
    parser.add_argument("--percentile","-per")
    ...
    label_img.get_stat2(ms_img,out_filename, stats = args.stats, percentile = \
